...
![传统4层架构](2024-09-03-架构-DDD应用架构/传统4层架构.png)
...
![分层架构](2024-09-03-架构-DDD应用架构/分层架构.png)
##### 用户接口层
...
#### 2.2、分层代码结构示例
系统架构：
![分层架构_系统架构](2024-09-03-架构-DDD应用架构/分层架构_系统架构.png)
包结构划分：
![分层架构_包结构划分](2024-09-03-架构-DDD应用架构/分层架构_包结构划分.png)
代码指导：
![分层架构_代码指示](2024-09-03-架构-DDD应用架构/分层架构_代码指示.png)


### 三、六边形架构
2005年，Alistair Cockburn提出了端口和适配器架构Ports & Adapters Architecture(又称六边形架构Hexagonal Architecture)。
![六边形架构](2024-09-03-架构-DDD应用架构/六边形架构.png)
端口和适配器架构中的相关概念：
...
![洋葱架构](2024-09-03-架构-DDD应用架构/洋葱架构.png)
...
![整洁架构](2024-09-03-架构-DDD应用架构/整洁架构.png)
与洋葱架构相比，整洁架构调整如下：
...
![清晰架构](2024-09-03-架构-DDD应用架构/清晰架构.png)
...
![总的架构演进图](2024-09-03-架构-DDD应用架构/总的架构演进图.png)
