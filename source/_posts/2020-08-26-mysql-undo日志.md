...
![undo_log_结构](2020-08-26-mysql-undo日志/undo_log_结构.png)
...
![undo_log_链表](2020-08-26-mysql-undo日志/undo_log_链表.png)
...
![undo_log_insert类型](2020-08-26-mysql-undo日志/undo_log_insert类型.png)


##### 2. update undo log长啥样
一条update sql对应undolog长如下这样：
![undo_log_update类型](2020-08-26-mysql-undo日志/undo_log_update类型.png)
...
![undo_log_物理存储方式](2020-08-26-mysql-undo日志/undo_log_物理存储方式.png)
...
> 
> 
> https://blog.csdn.net/2401_84186026/article/details/137882432