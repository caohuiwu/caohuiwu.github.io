...
# 二、mysql执行过程
mysql整体的执行过程如下图所示：
![MySQL执行过程](2020-08-13-mysql-源码分析-select流程/MySQL执行过程.png)

# 三、sql的执行顺序
![SQL执行顺序](2020-08-13-mysql-源码分析-select流程/SQL执行顺序.png)
...
# 四、数据更新流程
![数据更新过程](2020-08-13-mysql-源码分析-select流程/数据更新过程.png)
