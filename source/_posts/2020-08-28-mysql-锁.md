...
#### 2.1.4.4、意向锁的兼容性
![意向锁的兼容性](2020-08-28-mysql-锁/意向锁的兼容性.png)
- 意向排他锁和意向排他锁是兼容的
...
![lock_t](2020-08-28-mysql-锁/lock_t.png)
...
锁的内存结构示意图如下：
![锁的内存结构示意图](2020-08-28-mysql-锁/锁的内存结构示意图.png)
...
- 表锁/行锁信息 ：表锁结构和行锁结构在这个位置的内容是不同的：
  ...
  - <code>type_mode</code>：这是一个32位的数，被分成了<code>lock_mode、lock_type</code>和<code>rec_lock_type</code>三个部分。
    - ![type_mode](2020-08-28-mysql-锁/type_mode.png)
...
![hero_表](2020-08-28-mysql-锁/hero_表.png)
...
![唯一性搜索_代码](2020-08-28-mysql-锁/唯一性搜索_代码.png)
1. 匹配模式是精确匹配
...
![row_search_mvcc](2020-08-28-mysql-锁/row_search_mvcc.png)
可以看到这个函数长到吓人，有一千多行。
...
## 4.3、语句到底是怎么加锁的
首先看一个十分重要的变量：
![set_also_gap_locks](2020-08-28-mysql-锁/set_also_gap_locks.png)
...
![set_also_gap_locks_变化](2020-08-28-mysql-锁/set_also_gap_locks_变化.png)
...
![普通select](2020-08-28-mysql-锁/普通select.png)
...
![btr_pcur_open_with_no_init](2020-08-28-mysql-锁/btr_pcur_open_with_no_init.png)
...
![第2_二级索引图](2020-08-28-mysql-锁/第2_二级索引图.png)
...
![第2_sel_set_rec_lock](2020-08-28-mysql-锁/第2_sel_set_rec_lock.png)
...
![第3_处理Infimum](2020-08-28-mysql-锁/第3_处理Infimum.png)
...
![第4_精确匹配](2020-08-28-mysql-锁/第4_精确匹配.png)
...
![第6_icp](2020-08-28-mysql-锁/第6_icp.png)
...
![第7_正经记录锁](2020-08-28-mysql-锁/第7_正经记录锁.png)
